...
#    time.sleep(1)
    ...
    for z in range(48):
        ...
        strip.show()
        time.sleep(.02)
        strip.fill(format_tuple(0, z, z))
        strip.show()
        time.sleep(.02)
        strip.fill(format_tuple(z, z, z))
        strip.show()
        time.sleep(.02)
        strip.fill(format_tuple(z, z, 0))
        strip.show()
        time.sleep(.02)
        strip.fill(format_tuple(z, 0, 0))
        strip.show()
        time.sleep(.02)
        strip.fill(format_tuple(z, z, 0))
        strip.show()
...
#    rainbow_cycle(0.0025)    # rainbowcycle with 1ms delay per step